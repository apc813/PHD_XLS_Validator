...
str_filepath_txt_both = file.path(str_filepath_base,"squalodon_calvertensis_base_combined.txt")
...
```{r 01_ReadData}
df_csv_arc?h <- read.csv(str_filepath_txt_arch,
                   header=FALSE,
                   col.names=c("X","Y","Z"))

df_csv_base <- read.csv(str_filepath_txt_base,
                   header=FALSE,
                   col.names=c("X","Y","Z"))
